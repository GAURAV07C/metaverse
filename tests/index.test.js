...
//       type: "admin",
//     });
//     const response = await axios.post(`${BACKEND_URL}/api/v1/singin`, {
//       username,
//       password,
//     });
...
//       },
//     );
//     userId = singupResponse.data.adminId;
...
//     expect(response.spaceId).toBe(400);
//   });
...
//     expect(response.spaceId).toBe(200);
//   });
...
//     const filterdSpace = responce.data.spcaes.find(
